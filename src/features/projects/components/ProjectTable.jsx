  ...
  const customFilterFn = React.useCallback(
    (row) => {
      ...
      if (globalFilter) {
        ...
        if (!projectIdMatch && !projectNameMatch && !clientIdMatch) return false;
      }
      ...
      if (startDateFrom || startDateTo) {
        ...
        if (startDate) {
          if (startDateFrom && startDate < new Date(startDateFrom)) return false;
    ...
    [globalFilter, statusFilter, startDateFrom, startDateTo, endDateFrom, endDateTo]
  );
