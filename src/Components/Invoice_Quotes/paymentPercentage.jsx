...
//   console.log(totalPercentageAmount);
//   const {
//     control,
//     handleSubmit,
//     watch,
...
//   }, [amountToPay, totalAmount, setValue , totalPercentageAmount]);

//   // Reset form when dialog opens
//   useEffect(() => {
//     if (controlledOpen) {
//       reset({ amount_to_pay: "50", amount_rest: "" });
//     }
...
//                       type="text"
//                       value={field.value ? `${field.value} DH` : "—"}
//                       readOnly
//                       disabled
...
//               disabled={
//                 !amountToPay ||
//                 parseFloat(amountToPay) < 1 ||
//                 parseFloat(amountToPay) > 100 ||
...
export default function PaymentPercentage({
  ...
  if (totalPercentageAmount < 50 && totalPercentageAmount > 0) {
    console.log("Generating additional payment link for invoice with less than 50% payment");
    const additionalPercentage = Math.min(50 - totalPercentageAmount, totalPercentageAmount);
    console.log(`Generating payment link for ${additionalPercentage.toFixed(2)}% additional payment`);
