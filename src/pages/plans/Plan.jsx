...
//         <div className="flex gap-4 w-full bg-red-500">
...
export default function Plan({ plan }) {
  ...
  return (
    <Card className="overflow-hidden flex flex-col h-full ">
      ...
      <CardContent className="flex-1 flex flex-col px-4 space-y-4 ">
        {/* Top / fixed content */}
        ...
        {/* Growing section – takes remaining space */}
        ...
        <div className="flex gap-4 w-full pt-4 mt-auto border-gray-200">
          <Button variant="outline" className="flex-1" onClick={handleEdit}>
            <Edit className="mr-2 h-4 w-4" /> Edit
          </Button>
